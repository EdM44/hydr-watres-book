...
The hydraulic jump will either begin at y1 (and jump to the sequent depth for y1) or end at y2 (beginning at the sequent depth for y2). The possibilities are shown in Figure \@ref(fig:gvfcurves) in the lower right panel. First check the two sequent depths.
