...
For this example, we will extract a single year, but set the dates to ensure the entire snow season is contained within a year. The `snotel_phelology` function makes this easy. By default it uses an offset of 180 days to accomplish this.
...
```{r sno-7, message=FALSE, warning=FALSE, fig.align = 'center', out.width = "60%", fig.cap = "Optimal simulation of SWE at SNOTEL site 1050 for Winter 2008-2009."}
