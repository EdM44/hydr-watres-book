...
Set up a function for the Horton equation and use the built in `stats` package function `nls` to solve for the parameters. This works with column names of 'Time' and 'Rate'.
