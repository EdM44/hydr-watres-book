...
```{r mapview1, message=FALSE, eval=FALSE}
...
```{r nhdplus_df_assembly, message=FALSE}
...
> - Using the [rnoaa](https://cran.r-project.org/package=rnoaa) package, referring to the [vignettes](https://docs.ropensci.org/rnoaa/). This package has limited functionality and is being replaced.
...
scc_precip <- terra::crop(prcp, scc_bound, mask=TRUE)
