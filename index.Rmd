...
author: 
  - name: "[Ed Maurer](https://www.engr.scu.edu/~emaurer)"
    affiliation: "Professor, [Civil, Environmental, and Sustainable Engineering Department, Santa Clara University](https://www.scu.edu/engineering/academic-programs/engineering/ce/)"
date: "`r Sys.Date()`"
...
In what follows, text will be intentionally brief. More extensive discussion and description can be found in any fluid mechanics, applied hydraulics, or water resources engineering text. Symbology in this reference generally follows that Finnemore and Franzini [-@finnemore_fluid_2002]. Fundamental equations will be introduced though the emphasis will be on applications to solve common problems. Also, since this is written by a civil engineer, the only fluids included are water and air, since that accounts for nearly all problems encountered in the field.
