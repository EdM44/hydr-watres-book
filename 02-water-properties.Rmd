...
\begin{equation}
  \frac{v_2-v_1}{v_1}=\frac{\rho_1-\rho_2}{\rho_2}=-\frac{p_2-p_1}{E_v}
  (\#eq:bm-2)
\end{equation}
where $\rho$ is the density, $v$ is the specific volume ($v=\frac{1}{\rho}$) and $p$ is pressure.
