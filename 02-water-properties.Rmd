...
::: {.example #ex-bm}
A barrel of water has an initial temperature of 15 $^\circ$C at atmospheric pressure (p=0 Pa gage). Plot the  pressure the barrel must exert the have no change in volume as the water warms to 20 $^\circ$C.
:::
```{r out.width='20%', out.extra='style="float:right; padding:10px"', echo=FALSE}
